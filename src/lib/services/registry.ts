  ...
  },
{
  ...
  title: "Deploy Server",
  icon: "server",
  internalUrl: "http://localhost:4000/health",
  externalUrl: "https://deploy.suenify.com/health",
  primary: "external",
  description: "GitHub Webhook 기반 자동 배포 서버",
  serviceKind: "api",
  placement: "main",
  adminGroup: "services",
  enabled: true,
  monitoringEnabled: true,
  monitorMode: "internal-api",
  note: "admin/web 자동 배포 서버",
  accessInfo: "/deploy/admin, /deploy/web",
  ruleSummary: "health API 응답 기준",
  pendingDetail: "Deploy Server 상태 확인 중",
  metricA: "Health",
  metricB: "Deploy",
  metadata: {
    lastCheckedUrl: "https://deploy.suenify.com/health",
  },
},
  {
    id: "jellyfin",
